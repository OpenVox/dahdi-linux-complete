...
static struct device_attribute dev_attr_dahdi_spantype = __ATTR(spantype,S_IWUSR | S_IRUGO, dahdi_spantype_show,
	       dahdi_spantype_store);

static struct device_attribute dev_attr_dahdi_registration_time = __ATTR(registration_time, S_IRUGO, dahdi_registration_time_show, NULL);
