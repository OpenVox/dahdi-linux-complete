...
#else
	static const struct proc_ops param_proc_fops = {	
		.proc_open = open_param_proc,
		.proc_read = read_param_proc,
		.proc_write = write_param_proc,
	};
#endif
...
#else
    static const struct proc_ops param_freq_proc_fops = {       
        .proc_open   = open_param_freq_proc,
        .proc_read   = read_param_freq_proc,
        .proc_write  = write_param_freq_proc,
    };
#endif
